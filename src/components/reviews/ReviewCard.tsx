...
export function ReviewCard({
  ...
  return (
    <article className="rounded-2xl border border-line px-5 py-5">
      ...
      <div className="mt-3 flex flex-wrap items-center gap-2 text-xs text-navy-muted">
        ...
        <span className="rounded-full bg-surface px-2 py-0.5 font-medium text-navy">Verified Purchase</span>
      </div>
    </article>
  )
}
